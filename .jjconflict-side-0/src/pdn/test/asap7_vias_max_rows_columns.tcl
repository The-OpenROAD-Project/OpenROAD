# test for max_columns and max_rows on connect statements
source "helpers.tcl"
...
add_pdn_connect -layers {M8 M9} -max_columns 5 -max_rows 3

pdngen -skip_trim

set def_file [make_result_file asap7_vias_max_rows_columns.def]
write_def $def_file
diff_files asap7_vias_max_rows_columns.defok $def_file
