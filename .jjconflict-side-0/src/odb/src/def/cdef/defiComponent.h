...
EXTERN int defiComponentMaskShiftLayer_numMaskShiftLayers(
    const defiComponentMaskShiftLayer* obj);
EXTERN const char* defiComponentMaskShiftLayer_maskShiftLayer(
    const defiComponentMaskShiftLayer* obj,
    int index);
...
EXTERN void defiComponent_regionBounds(const defiComponent* obj,
                                       int* size,
                                       int** xl,
                                       int** yl,
                                       int** xh,
