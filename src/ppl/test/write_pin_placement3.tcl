...
set_io_pin_constraint -mirrored_pins {req_msg[0] resp_msg[0] req_msg[1] resp_msg[1] req_msg[2] resp_msg[2] req_msg[3] resp_msg[3] req_msg[4] resp_msg[4] req_msg[5] resp_msg[5] req_msg[6] resp_msg[6] req_msg[7] resp_msg[7] req_msg[8] resp_msg[8] req_msg[9] resp_msg[9] req_msg[10] resp_msg[10]}
