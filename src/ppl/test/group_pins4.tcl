...
set_io_pin_constraint \
  -pin_names {req_msg[24] req_msg[25] req_msg[26] req_msg[27] req_msg[28] req_msg[29] req_msg[2] req_msg[30] req_msg[31] req_msg[3] req_msg[4] req_msg[5] req_msg[6] req_msg[7] req_msg[8] req_msg[9]} \
  -region bottom:5-95

set_io_pin_constraint \
  -pin_names {clk req_rdy req_val reset resp_msg[0] resp_msg[10] resp_msg[11] resp_msg[12] resp_msg[13] resp_msg[14] resp_msg[15]} \
  -region top:15-95

set_io_pin_constraint \
  -pin_names {resp_rdy resp_val resp_msg[1] resp_msg[2] resp_msg[3] resp_msg[4] resp_msg[5] resp_msg[6] resp_msg[7] resp_msg[8] resp_msg[9]} \
  -region right:35-75
