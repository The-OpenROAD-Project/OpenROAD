...
define_pin_shape_pattern -layer metal10 -x_step 4.8 -y_step 4.8 \
  -region { 0.095 0.07 90 90 } -size { 1.6 2.5 }

set_io_pin_constraint -pin_names {clk resp_val req_val resp_rdy reset req_rdy} \
