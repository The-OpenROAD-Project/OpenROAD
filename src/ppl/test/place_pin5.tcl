...
place_pin -pin_name resp_val -layer metal7 -location {40 30} \
  -pin_size {1.6 2.5} -force_to_die_boundary

place_pin -pin_name req_val -layer metal7 -location {40 30} \
  -pin_size {1.6 2.5} -force_to_die_boundary
...
diff_files place_pin5.defok $def_file
