...
export function createInspectorPanel(app, redrawAllLayers, refreshOverlay) {
    ...
    function makeCollapsibleGroup(name, count, collapsed) {
        ...
        // Two listeners: the arrow's click also bubbles to the header, so
        // clicking the arrow toggles twice and leaves the group as it was.
        // That is fixed on the web-display-controls branch by dropping this
        // arrow listener; kept as-is here so the two branches don't fix the
        // same line twice.
