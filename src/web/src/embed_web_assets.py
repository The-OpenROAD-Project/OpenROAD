...
def main():
    ...
    for arg in args.assets:
        ...
        with open(path, "rb") as f:
            data = f.read()
        assets.append((served, c_identifier(served), mime, data))

    # Before the output file exists: a refusal in here would otherwise leave a
    # truncated .cpp newer than its inputs, which the next build does not
    # regenerate.
