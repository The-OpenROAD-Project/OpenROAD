...
import { applySelectionFlags, beginSelection, boundsEqual, buildMapOptions,
         ...
         computeScaleBar, decorateTabIcons, formatDbu, formatDistance,
         installWheelPanning, isCurrentSelection, isStaticMode, maxUsefulZoom,
         parseDbu, rafCoalesce, showToast, unitLabel }
    from './ui-utils.js';
