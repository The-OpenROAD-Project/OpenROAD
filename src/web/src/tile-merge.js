...
// until something forces a full invalidation.  See docs/tile-memory.md
// for the experiments; the short version is that the symptom tracks decoded
// image bytes and is indifferent to pane count and to how the bytes are
// distributed.
//
