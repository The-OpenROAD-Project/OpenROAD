...
#define SWIG_init    Ant_Init
#define SWIG_name    "ant"
#define SWIG_prefix  "ant::"
#define SWIG_namespace "ant"
...
#endif
SWIGINTERN int
_wrap_check_antennas(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  bool arg2 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:ant::check_antennas report_filename report_violating_nets ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "check_antennas" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  ecode2 = SWIG_AsVal_bool SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "check_antennas" "', argument " "2"" of type '" "bool""'");
  } 
  arg2 = static_cast< bool >(val2);
  {
    try {
      result = (int)ant::check_antennas(arg1,arg2); 
    }
    catch (std::bad_alloc &) {
...
SWIGINTERN int
_wrap_check_max_length(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  int arg2 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:ant::check_max_length net_name layer ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "check_max_length" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  ecode2 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "check_max_length" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  {
    try {
      ant::check_max_length((char const *)arg1,arg2); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(0);
...
SWIGINTERN int
_wrap_load_antenna_rules(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":ant::load_antenna_rules ") == TCL_ERROR) SWIG_fail;
  {
    try {
...
SWIGINTERN int
_wrap_check_net_violation(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:ant::check_net_violation net_name ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "check_net_violation" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  {
    try {
      result = (bool)ant::check_net_violation(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(0);
...
_wrap_find_max_wire_length(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":ant::find_max_wire_length ") == TCL_ERROR) SWIG_fail;
  {
    try {
      ant::find_max_wire_length(); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      exit(0);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "check_antennas", (swig_wrapper_func) _wrap_check_antennas, NULL},
    { SWIG_prefix "check_max_length", (swig_wrapper_func) _wrap_check_max_length, NULL},
    { SWIG_prefix "load_antenna_rules", (swig_wrapper_func) _wrap_load_antenna_rules, NULL},
    { SWIG_prefix "check_net_violation", (swig_wrapper_func) _wrap_check_net_violation, NULL},
...
SWIGEXPORT int Ant_SafeInit(Tcl_Interp *interp) {
