...
| `-pin_aware_channels` | Trim channels based on pin location of macros, instead of using full/uniform channels. Requires `-min_channel_size` to also be set. |
...
### Set Macro Base Halo
**Deprecated: use odb::set_halo or -min_channel_size instead.**
