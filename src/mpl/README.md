...
| `-use_def_halo` | Use the halo values from the DEF `HALO` annotation. By default, DEF halos are ignored and the halo is controlled via `-halo_width`/`-halo_height` or `set_macro_halo`. |
