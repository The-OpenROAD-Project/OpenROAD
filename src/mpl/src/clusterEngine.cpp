...
void ClusteringEngine::init()
{
  ...
  setDieArea();
  setFloorplanShape();
  searchForFixedCellsInsideFloorplanShape();
...
void ClusteringEngine::searchForFixedCellsInsideFloorplanShape()
{
...
bool ClusteringEngine::isIgnoredInst(odb::dbInst* inst)
{
  ...
  /*
    TODO: Not ignoring fixed instances will probably break a private design
    due to some fixed special cells. Handle this.
  */
...
void ClusteringEngine::breakMixedLeaf(Cluster* mixed_leaf)
{
  ...
  for (Cluster* fixed_macro_cluster : fixed_macro_clusters) {
    ...
    /*
      TODO: Handle virtual connections.
    */
  }
