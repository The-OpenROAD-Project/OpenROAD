set test_case gcd_flow_v2_model_v1_no_via_merge
...
extract_parasitics -ext_model_file $model_v1 -max_res 0 -coupling_threshold 0.1 -version 2.0 -skip_over_cell -no_merge_via_res
