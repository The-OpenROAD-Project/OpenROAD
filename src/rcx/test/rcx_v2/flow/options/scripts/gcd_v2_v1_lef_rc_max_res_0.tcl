set test_case gcd_v2_v1_lef_rc_max_res_0
...
extract_parasitics -ext_model_file $model_v1 -coupling_threshold 0.1 -version 2.0 -skip_over_cell -no_merge_via_res -max_res 0 -lef_rc
