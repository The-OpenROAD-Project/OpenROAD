...
Tcl_Obj* PSN_SwigString_FromString(std::string s) {
    return Tcl_NewStringObj(s.c_str(), s.length());
}

int PSN_SwigString_AsString(Tcl_Interp *interp, Tcl_Obj *o, std::string *val) {
    int len;
...
int PSN_SwigInt_As(Tcl_Interp *interp, Tcl_Obj *o, Type *val) {
...
template <typename Type>
int PSN_SwigDouble_As(Tcl_Interp *interp, Tcl_Obj *o, Type *val) {
    int return_val;
    double temp_val;
...
namespace std {
    ...
    %define psn_specialize_std_vector(T, CONVERT_FROM, CONVERT_TO)
    ...
    psn_specialize_std_vector(bool, Tcl_GetBoolFromObj, Tcl_NewBooleanObj);
    psn_specialize_std_vector(char, Tcl_GetIntFromObj,Tcl_NewIntObj);
    psn_specialize_std_vector(int, Tcl_GetIntFromObj,Tcl_NewIntObj);
    psn_specialize_std_vector(short, PSN_SwigInt_As<short>, Tcl_NewIntObj);
    psn_specialize_std_vector(long, PSN_SwigInt_As<long>, Tcl_NewIntObj);
    psn_specialize_std_vector(unsigned char, 
                          PSN_SwigInt_As<unsigned int>, Tcl_NewIntObj);
    psn_specialize_std_vector(unsigned int, 
                          PSN_SwigInt_As<unsigned int>, Tcl_NewIntObj);
    psn_specialize_std_vector(unsigned short, 
                          PSN_SwigInt_As<unsigned short>, Tcl_NewIntObj);
    psn_specialize_std_vector(unsigned long, 
                          PSN_SwigInt_As<unsigned long>, Tcl_NewIntObj);
    psn_specialize_std_vector(double, Tcl_GetDoubleFromObj, Tcl_NewDoubleObj);
    psn_specialize_std_vector(float, PSN_SwigDouble_As<float>, Tcl_NewDoubleObj);
    psn_specialize_std_vector(std::string, 
                          PSN_SwigString_AsString, PSN_SwigString_FromString);
