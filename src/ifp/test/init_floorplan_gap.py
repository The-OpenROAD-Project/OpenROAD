...
try:
    ...
    floorplan.makeRows(core, site, [], "NONE", openroad.site_set(), design.micronToDBU(-1))
except Exception:
    pass
# initialize_floorplan -gap 0
try:
    floorplan.makeDie(die)
    floorplan.makeRows(core, site, [], "NONE", openroad.site_set(), design.micronToDBU(0))
except Exception:
    pass
# make_rows -gap -1
try:
...
floorplan.makeDie(die)
floorplan.makeRows(core, site, [additional_site], "NONE", openroad.site_set(), design.micronToDBU(2))
