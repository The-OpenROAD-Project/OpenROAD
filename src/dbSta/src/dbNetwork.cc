...
void dbNetwork::disconnectPinBefore(const Pin* pin)
{
  ...
  if (db_net) {
    ...
    odb::OdbPtrSet<odb::dbModNet> related_mod_nets;
...
void dbNetwork::checkSanityUnusedModules() const
{
  ...
  odb::OdbPtrSet<odb::dbModule> instantiated_masters;
...
void dbNetwork::checkSanityNetConnectivity(odb::dbObject* obj) const
{
  ...
  if (obj != nullptr) {
    ...
    odb::OdbPtrSet<odb::dbNet> nets_to_check;
    odb::OdbPtrSet<odb::dbModNet> mod_nets_to_check;
...
void dbNetwork::checkSanityNetNames() const
{
  ...
  for (odb::dbNet* net : block_->getNets()) {
    odb::OdbPtrSet<odb::dbModNet> mod_nets;
