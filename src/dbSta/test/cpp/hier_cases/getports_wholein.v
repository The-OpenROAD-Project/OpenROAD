// TOP: top
// TECH: nangate45
// TARGETS: bus_slice_assign, submodule_feedthrough, no_input_slicing
// CLUE: get_ports1 shape with the instance bus input connected WHOLE instead of .in_bus(top_in_bus[3:0]): if this passes, input slicing is the finding-2 trigger.
