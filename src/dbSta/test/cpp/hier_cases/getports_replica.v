// TOP: top
// TECH: nangate45
// TARGETS: bus_slice_assign, submodule_feedthrough, concat_rhs
// CLUE: near-exact replica of the get_ports1.v known-finding-2 pattern (control that the campaign detects the known flat drop).
