// TOP: top
// TECH: nangate45
// TARGETS: bus_slice_assign, submodule_feedthrough, no_concat
// CLUE: get_ports1 shape with the top-level concat assign expanded into per-bit assigns: isolates the concat from the internal-wire alias.
...
module top (input [7:0] top_in_bus, input top_in_single,
  ...
  assign top_out_bus[4] = top_in_bus[7];
  assign top_out_bus[3] = top_in_bus[6];
  assign top_out_bus[2] = top_in_bus[5];
