...
# only consults findModBTerm when cur_inst's hierarchical path equals
# module's), check_axioms must NOT report ORD-2059, and link_design
# must NOT abort with ORD-2030 from the cross-aliased flat net.
