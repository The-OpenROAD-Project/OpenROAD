...
# same as met3
#set_wire_rc -clock  -capacitance [expr 1.4e-10 * 1e-6 * 1e+12] \
# -resistance [expr 166800.0 * 1e-6 * 1e-3]
#set_wire_rc -clock  -capacitance [expr 100e-10 * 1e-6 * 1e+12] \
# -resistance [expr 166800.0 * 1e-6 * 1e-3]

set_cts_config -root_buf sky130_fd_sc_hs__clkbuf_1 \
