...
clock_tree_synthesis -root_buf CLKBUF_X3 -buf_list CLKBUF_X3  -wire_unit 20  -sink_clustering_enable  -distance_between_buffers 100  -sink_clustering_size 10 -sink_clustering_max_diameter 60  -num_static_layers 1
