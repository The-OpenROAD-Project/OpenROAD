...
const char* lefiPinAntennaModel_antennaGateAreaLayer(
    ...
    int index)
{
  return ((const LefDefParser::lefiPinAntennaModel*) obj)
...
double lefiPinAntennaModel_antennaMaxSideAreaCar(
    ...
    int index)
{
  return ((LefDefParser::lefiPinAntennaModel*) obj)
      ->antennaMaxSideAreaCar(index);
}
...
const char* lefiPin_antennaPartialMetalAreaLayer(const ::lefiPin* obj,
                                                 int index)
{
  return ((const LefDefParser::lefiPin*) obj)
      ->antennaPartialMetalAreaLayer(index);
}
...
{
  return ((const LefDefParser::lefiPin*) obj)
      ->antennaPartialCutAreaLayer(index);
}
...
const ::lefiPinAntennaModel* lefiPin_antennaModel(const ::lefiPin* obj,
                                                  int index)
{
  return (const ::lefiPinAntennaModel*) ((LefDefParser::lefiPin*) obj)
      ->antennaModel(index);
}
...
const ::lefiSitePattern* lefiMacro_sitePattern(const ::lefiMacro* obj,
                                               int index)
{
  return (const ::lefiSitePattern*) ((LefDefParser::lefiMacro*) obj)
      ->sitePattern(index);
}
