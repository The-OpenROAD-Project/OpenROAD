...
{
  LefDefParser::lefwSetManufacturingGridCbk(
      (LefDefParser::lefwVoidCbkFnType) p0);
}
...
{
  LefDefParser::lefwSetClearanceMeasureCbk(
      (LefDefParser::lefwVoidCbkFnType) p0);
}
...
{
  LefDefParser::lefwAntennaInputGateAreaCbk(
      (LefDefParser::lefwVoidCbkFnType) p0);
}

void lefwAntennaInOutDiffAreaCbk(::lefwVoidCbkFnType p0)
{
  LefDefParser::lefwAntennaInOutDiffAreaCbk(
      (LefDefParser::lefwVoidCbkFnType) p0);
}

void lefwAntennaOutputDiffAreaCbk(::lefwVoidCbkFnType p0)
{
  LefDefParser::lefwAntennaOutputDiffAreaCbk(
      (LefDefParser::lefwVoidCbkFnType) p0);
}
