...
double lefiParallel_widthSpacing(const ::lefiParallel* obj,
                                 ...
                                 int iWidthSpacing)
{
  return ((LefDefParser::lefiParallel*) obj)
      ->widthSpacing(iWidth, iWidthSpacing);
}
...
double lefiTwoWidths_widthSpacing(const ::lefiTwoWidths* obj,
                                  ...
                                  int iWidthSpacing)
{
  return ((LefDefParser::lefiTwoWidths*) obj)
      ->widthSpacing(iWidth, iWidthSpacing);
}
...
{
  return (const ::lefiInfluence*) ((LefDefParser::lefiSpacingTable*) obj)
      ->influence();
}
...
{
  return (const ::lefiParallel*) ((LefDefParser::lefiSpacingTable*) obj)
      ->parallel();
}

const ::lefiTwoWidths* lefiSpacingTable_twoWidths(const ::lefiSpacingTable* obj)
{
  return (const ::lefiTwoWidths*) ((LefDefParser::lefiSpacingTable*) obj)
      ->twoWidths();
}
...
{
  return ((LefDefParser::lefiAntennaModel*) obj)
      ->hasAntennaCumDiffAreaRatioPWL();
}
...
{
  return ((LefDefParser::lefiAntennaModel*) obj)
      ->hasAntennaDiffSideAreaRatioPWL();
}
...
{
  return ((LefDefParser::lefiAntennaModel*) obj)
      ->hasAntennaCumDiffSideAreaRatio();
}
...
const ::lefiAntennaPWL* lefiAntennaModel_antennaDiffAreaRatioPWL(
    const ::lefiAntennaModel* obj)
{
  return (const ::lefiAntennaPWL*) ((LefDefParser::lefiAntennaModel*) obj)
...
int lefiLayer_hasSpacingRangeUseLengthThreshold(const ::lefiLayer* obj,
                                                int index)
{
  return ((LefDefParser::lefiLayer*) obj)
...
{
  return ((LefDefParser::lefiLayer*) obj)
      ->hasSpacingLengthThresholdRange(index);
}
...
{
  return ((LefDefParser::lefiLayer*) obj)
      ->spacingLengthThresholdRangeMin(index);
}
...
{
  return ((LefDefParser::lefiLayer*) obj)
      ->spacingLengthThresholdRangeMax(index);
}
...
{
  ((LefDefParser::lefiLayer*) obj)
      ->capacitanceArray(numPoints, widths, resValues);
}
...
{
  ((LefDefParser::lefiLayer*) obj)
      ->resistanceArray(numPoints, widths, capValues);
}
...
{
  return (const ::lefiLayerDensity*) ((LefDefParser::lefiLayer*) obj)
      ->accurrent(index);
}
...
const ::lefiAntennaModel* lefiLayer_antennaModel(const ::lefiLayer* obj,
                                                 int index)
{
  return (const ::lefiAntennaModel*) ((LefDefParser::lefiLayer*) obj)
      ->antennaModel(index);
}
...
{
  return (const ::lefiOrthogonal*) ((LefDefParser::lefiLayer*) obj)
      ->orthogonal();
}
