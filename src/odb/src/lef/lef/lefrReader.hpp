...
using lefrVoidCbkFnType = int (*)(lefrCallbackType_e, void* num, lefiUserData);

// A declaration of the signature of all callbacks that return a string.
using lefrStringCbkFnType
    = int (*)(lefrCallbackType_e, const char* string, lefiUserData);

// A declaration of the signature of all callbacks that return a integer.
using lefrIntegerCbkFnType
    = int (*)(lefrCallbackType_e, int number, lefiUserData);

// A declaration of the signature of all callbacks that return a double.
using lefrDoubleCbkFnType
    = int (*)(lefrCallbackType_e, double number, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiUnits.
using lefrUnitsCbkFnType
    = int (*)(lefrCallbackType_e, lefiUnits* units, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiLayer.
using lefrLayerCbkFnType
    = int (*)(lefrCallbackType_e, lefiLayer* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiVia.
using lefrViaCbkFnType = int (*)(lefrCallbackType_e, lefiVia* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiViaRule.
using lefrViaRuleCbkFnType
    = int (*)(lefrCallbackType_e, lefiViaRule* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiSpacing.
using lefrSpacingCbkFnType
    = int (*)(lefrCallbackType_e, lefiSpacing* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiIRDrop.
using lefrIRDropCbkFnType
    = int (*)(lefrCallbackType_e, lefiIRDrop* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiMinFeature.
using lefrMinFeatureCbkFnType
    = int (*)(lefrCallbackType_e, lefiMinFeature* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiNonDefault.
using lefrNonDefaultCbkFnType
    = int (*)(lefrCallbackType_e, lefiNonDefault* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiSite.
using lefrSiteCbkFnType
    = int (*)(lefrCallbackType_e, lefiSite* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiMacro.
using lefrMacroCbkFnType
    = int (*)(lefrCallbackType_e, lefiMacro* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiPin.
using lefrPinCbkFnType = int (*)(lefrCallbackType_e, lefiPin* l, lefiUserData);

// A declaration of the signature of all callbacks that return a
// lefiObstruction.
using lefrObstructionCbkFnType
    = int (*)(lefrCallbackType_e, lefiObstruction* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiArray.
using lefrArrayCbkFnType
    = int (*)(lefrCallbackType_e, lefiArray* l, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiProp.
using lefrPropCbkFnType
    = int (*)(lefrCallbackType_e, lefiProp* p, lefiUserData);

// A declaration of the signature of all callbacks that return a
// lefiNoiseMargin.
using lefrNoiseMarginCbkFnType
    = int (*)(lefrCallbackType_e, struct lefiNoiseMargin* p, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiNoiseTable.
using lefrNoiseTableCbkFnType
    = int (*)(lefrCallbackType_e, lefiNoiseTable* p, lefiUserData);

// A declaration of the signature of all callbacks that return a
// lefiCorrectionTable.
using lefrCorrectionTableCbkFnType
    = int (*)(lefrCallbackType_e, lefiCorrectionTable* p, lefiUserData);

// A declaration of the signature of all callbacks that return a lefiTiming.
using lefrTimingCbkFnType
    = int (*)(lefrCallbackType_e, lefiTiming* p, lefiUserData);

// A declaration of the signature of all callbacks that return a
// lefiUseMinSpacing.
using lefrUseMinSpacingCbkFnType
    = int (*)(lefrCallbackType_e, lefiUseMinSpacing* l, lefiUserData);
...
// A declaration of the signature of all callbacks that return a
// lefiMaxStackVia.
using lefrMaxStackViaCbkFnType
    = int (*)(lefrCallbackType_e, lefiMaxStackVia* l, lefiUserData);

using lefrMacroNumCbkFnType
    = int (*)(lefrCallbackType_e, lefiNum l, lefiUserData);

using lefrMacroSiteCbkFnType
    = int (*)(lefrCallbackType_e, const lefiMacroSite* site, lefiUserData);

using lefrMacroForeignCbkFnType = int (*)(lefrCallbackType_e,
                                          const lefiMacroForeign* foreign,
                                          lefiUserData);

// 5.6
// A declaration of the signature of all callbacks that return a lefiDensity.
using lefrDensityCbkFnType
    = int (*)(lefrCallbackType_e, lefiDensity* l, lefiUserData);
...
using LEFI_READ_FUNCTION = size_t (*)(FILE*, char*, size_t);
