...
static FILE* lefwFile = nullptr;   // File to write to.
...
static int lefwDidVia = 0;                // required section
static int lefwDidViaRule = 0;            // required section
static int lefwDidViaSite = 0;            // required section
static int lefwDidViaMacro = 0;           // required section
static int lefwCounter = 0;               // number of nets, components in section
static int lefwLineItemCounter = 0;       // number of items on current line
...
static int lefwIsMacroPinPortLayer = 0;   // macro pin port layer within macro pin port
...
static int lefwIsRoutingReqData = 0;      // layer routing required data are provided
...
static int lefwHasInit = 0;               // for lefwInit has called
static int lefwHasInitCbk = 0;            // for lefwInitCbk has called
