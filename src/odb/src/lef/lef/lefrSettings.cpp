...
void lefrSettings::init_symbol_table()
{
...
void lefrSettings::disableMsg(int msgId)
{
  msgsDisableMap[msgId] = 0;
}

void lefrSettings::enableMsg(int msgId)
{
...
void lefrSettings::enableAllMsgs()
{
...
int lefrSettings::suppresMsg(int msgId)
{
  std::map<int, int>::iterator search = msgsDisableMap.find(msgId);
