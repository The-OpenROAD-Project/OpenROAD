...
%token K_TIELOW K_TIEOFF K_TIEOFFR K_TIME K_TIMING K_TO K_TOPIN K_TOPLEFT K_TOPRIGHT
...
%token K_RECOVERY K_RESET K_SKEW K_ANYEDGE K_POSEDGE K_NEGEDGE
...
%token K_SPLITWIREWIDTH K_SCAN K_MINIMUMDENSITY K_MAXIMUMDENSITY K_DENSITYCHECKWINDOW
