...
defrCallbacks::defrCallbacks()
    : DesignCbk(nullptr),
      TechnologyCbk(nullptr),
      DesignEndCbk(nullptr),
      PropCbk(nullptr),
      PropDefEndCbk(nullptr),
      PropDefStartCbk(nullptr),
      ArrayNameCbk(nullptr),
      FloorPlanNameCbk(nullptr),
      UnitsCbk(nullptr),
      DividerCbk(nullptr),
      BusBitCbk(nullptr),
      SiteCbk(nullptr),
      CanplaceCbk(nullptr),
      CannotOccupyCbk(nullptr),
      ComponentStartCbk(nullptr),
      ComponentEndCbk(nullptr),
      ComponentCbk(nullptr),
      NetStartCbk(nullptr),
      NetEndCbk(nullptr),
      NetCbk(nullptr),
      NetNameCbk(nullptr),
      NetSubnetNameCbk(nullptr),
      NetNonDefaultRuleCbk(nullptr),
      NetPartialPathCbk(nullptr),
      PathCbk(nullptr),
      VersionCbk(nullptr),
      VersionStrCbk(nullptr),
      PinExtCbk(nullptr),
      ComponentExtCbk(nullptr),
      ViaExtCbk(nullptr),
      NetConnectionExtCbk(nullptr),
      NetExtCbk(nullptr),
      GroupExtCbk(nullptr),
      ScanChainExtCbk(nullptr),
      IoTimingsExtCbk(nullptr),
      PartitionsExtCbk(nullptr),
      HistoryCbk(nullptr),
      DieAreaCbk(nullptr),
      PinCapCbk(nullptr),
      PinCbk(nullptr),
      StartPinsCbk(nullptr),
      PinEndCbk(nullptr),
      DefaultCapCbk(nullptr),
      RowCbk(nullptr),
      TrackCbk(nullptr),
      GcellGridCbk(nullptr),
      ViaStartCbk(nullptr),
      ViaEndCbk(nullptr),
      ViaCbk(nullptr),
      RegionStartCbk(nullptr),
      RegionEndCbk(nullptr),
      RegionCbk(nullptr),
      SNetStartCbk(nullptr),
      SNetEndCbk(nullptr),
      SNetCbk(nullptr),
      SNetPartialPathCbk(nullptr),
      SNetWireCbk(nullptr),
      GroupsStartCbk(nullptr),
      GroupsEndCbk(nullptr),
      GroupNameCbk(nullptr),
      GroupMemberCbk(nullptr),
      GroupCbk(nullptr),
      AssertionsStartCbk(nullptr),
      AssertionsEndCbk(nullptr),
      AssertionCbk(nullptr),
      ConstraintsStartCbk(nullptr),
      ConstraintsEndCbk(nullptr),
      ConstraintCbk(nullptr),
      ScanchainsStartCbk(nullptr),
      ScanchainsEndCbk(nullptr),
      ScanchainCbk(nullptr),
      IOTimingsStartCbk(nullptr),
      IOTimingsEndCbk(nullptr),
      IOTimingCbk(nullptr),
      FPCStartCbk(nullptr),
      FPCEndCbk(nullptr),
      FPCCbk(nullptr),
      TimingDisablesStartCbk(nullptr),
      TimingDisablesEndCbk(nullptr),
      TimingDisableCbk(nullptr),
      PartitionsStartCbk(nullptr),
      PartitionsEndCbk(nullptr),
      PartitionCbk(nullptr),
      PinPropStartCbk(nullptr),
      PinPropEndCbk(nullptr),
      PinPropCbk(nullptr),
      CaseSensitiveCbk(nullptr),
      BlockageStartCbk(nullptr),
      BlockageEndCbk(nullptr),
      BlockageCbk(nullptr),
      SlotStartCbk(nullptr),
      SlotEndCbk(nullptr),
      SlotCbk(nullptr),
      FillStartCbk(nullptr),
      FillEndCbk(nullptr),
      FillCbk(nullptr),
      NonDefaultStartCbk(nullptr),
      NonDefaultEndCbk(nullptr),
      NonDefaultCbk(nullptr),
      StylesStartCbk(nullptr),
      StylesEndCbk(nullptr),
      StylesCbk(nullptr),
      ExtensionCbk(nullptr),
      ComponentMaskShiftLayerCbk(nullptr)
{
}
