...
EXTERN void defiVia_layer(const defiVia* obj,
                          int index,
                          char** layer,
                          int* xl,
                          int* yl,
...
EXTERN void defiVia_viaRule(const defiVia* obj,
                            char** viaRuleName,
                            int* xSize,
                            int* ySize,
                            char** botLayer,
...
EXTERN void defiVia_rowCol(const defiVia* obj,
                           int* numCutRows,
                           int* numCutCols);
...
EXTERN void defiVia_offset(const defiVia* obj,
                           int* xBotOffset,
                           int* yBotOffset,
                           int* xTopOffset,
                           int* yTopOffset);
