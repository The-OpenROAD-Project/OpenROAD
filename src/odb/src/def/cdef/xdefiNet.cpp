...
{
  return (const ::defiPath*) ((const LefDefParser::defiSubnet*) obj)
      ->path(index);
}
...
{
  return (const ::defiWire*) ((const LefDefParser::defiSubnet*) obj)
      ->wire(index);
}
...
{
  return (const ::defiPath*) ((const LefDefParser::defiShield*) obj)
      ->path(index);
}
...
{
  return (const ::defiSubnet*) ((const LefDefParser::defiNet*) obj)
      ->subnet(index);
}
...
{
  return (const ::defiShield*) ((const LefDefParser::defiNet*) obj)
      ->shield(index);
}
