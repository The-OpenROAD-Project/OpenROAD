...
int defiPinAntennaModel_hasAPinGateAreaLayer(const ::defiPinAntennaModel* obj,
                                             int index)
{
  return ((LefDefParser::defiPinAntennaModel*) obj)
...
const char* defiPinAntennaModel_APinGateAreaLayer(
    ...
    int index)
{
  return ((const LefDefParser::defiPinAntennaModel*) obj)
...
{
  return ((LefDefParser::defiPin*) obj)
...
const char* defiPin_APinPartialMetalSideAreaLayer(const ::defiPin* obj,
                                                  int index)
{
  return ((const LefDefParser::defiPin*) obj)
...
const ::defiPinAntennaModel* defiPin_antennaModel(const ::defiPin* obj,
                                                  int index)
{
  return (const ::defiPinAntennaModel*) ((LefDefParser::defiPin*) obj)
      ->antennaModel(index);
}
