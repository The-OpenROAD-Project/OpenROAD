  ...
  switch (obj_type) {
    case dbInstObj: {
      ...
      debugPrint(_logger,
                 ...
                 "DB_ECO",
                 2,
                 "ECO: swapMaster dbInst({}) '{}', prev lib/master: {}/{}, "
                 "new lib/master: {}/{}",
                 inst_id,
                 inst->getName(),
                 prev_lib_id,
  ...
  switch (obj_type) {
    ...
    case dbInstObj: {
      ...
      debugPrint(_logger,
                 ...
                 "DB_ECO",
                 3,
                 "UNDO ECO: delete dbInst({}) '{}' dbMaster({})",
                 inst_id,
                 name.c_str(),
                 master_id);
  ...
  switch (obj_type) {
    ...
    case dbBTermObj: {
      ...
      debugPrint(_logger,
                 ...
                 "DB_ECO",
                 3,
                 "UNDO ECO: connect dbBTerm({}) '{}' dbNet({}) dbModNet({})",
                 bterm_id,
                 bterm->getName(),
                 net_id,
                 mnet_id);
...
void dbJournal::undo_disconnectObject()
{
  ...
  switch (obj_type) {
    ...
    case dbModITermObj: {
      ...
      _log.pop(moditerm_id);
      _log.pop(modnet_id);
      dbModITerm* mod_iterm = dbModITerm::getModITerm(_block, moditerm_id);
      if (modnet_id != 0U) {
        dbModNet* mnet = dbModNet::getModNet(_block, modnet_id);
