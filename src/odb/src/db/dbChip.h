...
class dbChipNetCapNodeItr;
class dbChipNetRSegItr;
class _dbProperty;
class _dbChipRegion;
...
class _dbChip : public _dbObject
{
 public:
  ...
  dbChipNetCapNodeItr* chip_net_cap_node_itr_;
  dbChipNetRSegItr* chip_net_r_seg_itr_;
  ...
  dbTable<_dbChipCapNode>* chip_cap_node_tbl_;
  dbTable<_dbChipRSeg>* chip_r_seg_tbl_;
