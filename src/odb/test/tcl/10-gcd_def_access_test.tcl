...
check "block die area" {list [$die_area_rect xMin] [$die_area_rect yMin] [$die_area_rect xMax] \
             [$die_area_rect yMax]} "0 0 200260 201600"
...
check "master placement boundary" {set rect [$master getPlacementBoundary];
  list [$rect xMin] [$rect yMin] [$rect xMax] [$rect yMax]} "0 0 760 2800"
