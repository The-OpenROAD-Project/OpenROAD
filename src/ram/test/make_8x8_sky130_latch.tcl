...
set lef_file [make_result_file make_8x8_sky130_latch.lef]
write_abstract_lef -bloat_occupied_layers $lef_file
diff_files make_8x8_sky130_latch.lefok $lef_file

set def_file [make_result_file make_8x8_sky130_latch.def]
write_def $def_file
diff_files make_8x8_sky130_latch.defok $def_file
