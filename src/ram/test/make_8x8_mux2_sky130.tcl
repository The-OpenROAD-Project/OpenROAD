...
set behavioral_file [make_result_file make_8x8_mux2_behavioral.v]
generate_ram \
  -mask_size 8 \
  -word_size 8 \
  -num_words 8 \
...
set def_file [make_result_file make_8x8_mux2_sky130.def]
write_def $def_file
diff_files make_8x8_mux2_sky130.defok $def_file
