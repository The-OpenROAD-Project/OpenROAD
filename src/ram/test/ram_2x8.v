module RAM2x8 (clk,
 ...
 sky130_fd_sc_hd__dlclkp_1 \storage_0_0.cg  (.GATE(\storage_0_0.we0 ),
    ...
    .CLK(clk));
 sky130_fd_sc_hd__and2_0 \storage_0_0.gcand  (.A(\inv.addr [0]),
    .B(we[0]),
    .X(\storage_0_0.we0 ));
 sky130_fd_sc_hd__clkinv_1 \storage_0_0.select_inv_0  (.A(\inv.addr [0]),
 ...
 sky130_fd_sc_hd__dlclkp_1 \storage_1_0.cg  (.GATE(\storage_1_0.we0 ),
    ...
    .CLK(clk));
 sky130_fd_sc_hd__and2_0 \storage_1_0.gcand  (.A(addr[0]),
    .B(we[0]),
    .X(\storage_1_0.we0 ));
 sky130_fd_sc_hd__clkinv_1 \storage_1_0.select_inv_0  (.A(addr[0]),
