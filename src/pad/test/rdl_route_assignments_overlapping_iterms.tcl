...
set inst [[ord::get_db_block] findInst BUMP_1_16]
$inst setPlacementStatus PLACED
$inst setLocation [ord::microns_to_dbu 370] [ord::microns_to_dbu 2875]
$inst setPlacementStatus FIRM

# Move to overlap
set inst [[ord::get_db_block] findInst BUMP_0_16]
$inst setPlacementStatus PLACED
$inst setLocation [ord::microns_to_dbu 65] [ord::microns_to_dbu 2775]
$inst setPlacementStatus FIRM

# Move to be right next to it
set inst [[ord::get_db_block] findInst BUMP_0_15]
$inst setPlacementStatus PLACED
$inst setLocation [ord::microns_to_dbu 65] [ord::microns_to_dbu 2599.5]
$inst setPlacementStatus FIRM
...
rdl_route -layer metal10 -width 4 -spacing 4 "DVDD p_co2_8_o p_co2_6_o"

set def_file [make_result_file "rdl_route_assignments_overlapping_iterms.def"]
write_def $def_file
diff_files $def_file "rdl_route_assignments_overlapping_iterms.defok"
