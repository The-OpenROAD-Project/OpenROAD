...
if {[catch {ICeWall load_footprint coyote_tc/coyote_tc_no_center_information.package.strategy} msg]} {
  puts $errorInfo
  puts $msg
  exit
}
...
set def_file results/coyote_tc_sky130.no_pad_locations.def

write_def $def_file
diff_files $def_file coyote_tc_sky130.no_pad_locations.defok
