...
- `-routability_target_rc_metric`, `-routability_snapshot_overflow`, `-routability_check_overflow`, `-routability_max_density`, `-routability_inflation_ratio_coef`, `-routability_max_inflation_ratio`, `-routability_min_inflation_ratio`, `-routability_rc_coefficients`
...
| `-routability_min_inflation_ratio` | Tiles with a congestion value below this value will not be inflated. The default value is `0.9`, and the allowed values are floats `[0, 1]`. |
