# Clock-tree power knob raises banking: same design and -tray_weight as
# mbff_clock_power_off.tcl, but -clock_power_weight 3 credits the clock-tree
# power saved by banking, pushing the solution from 2-bit to 4-bit trays.
source helpers.tcl
...
cluster_flops -tray_weight 8.0 -timing_weight 0.0 \
  -max_split_size -1 -num_paths 0 -clock_power_weight 3.0
