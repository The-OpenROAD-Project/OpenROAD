...
read_def Nangate45_data/macros_odd_row_count.def

set def_file [make_result_file ignore_row_orientation_odd.def]

tapcell -distance "20" \
  -tapcell_master "TAPCELL_X1" \
  -endcap_master "ENDCAP_X4_RIGHTEDGE_Y" \
  -tap_nwin2_master "ENDCAP_X1_BOTTOMEDGE" \
  -tap_nwin3_master "ENDCAP_X1_BOTTOMEDGE" \
  -tap_nwout2_master "ENDCAP_X1_TOPEDGE" \
  -tap_nwout3_master "ENDCAP_X1_TOPEDGE" \
...
diff_file ignore_row_orientation_odd.defok $def_file
