...
options.tap_nwin2_master = "TAPCELL_X1"
options.tap_nwin3_master = "TAPCELL_X1"
options.tap_nwout2_master = "TAPCELL_X1"
options.tap_nwout3_master = "TAPCELL_X1"
options.tap_nwintie_master = "TAPCELL_X1"
options.tap_nwouttie_master = "TAPCELL_X1"
options.cnrcap_nwin_master = "TAPCELL_X1"
options.cnrcap_nwout_master = "TAPCELL_X1"
options.incnrcap_nwin_master = "TAPCELL_X1"
options.incnrcap_nwout_master = "TAPCELL_X1"
