...
int Tapcell::placeTapcells(odb::dbMaster* tapcell_master, const int dist)
{
  ...
  odb::OdbPtrSet<odb::dbRow> edge_rows;
                           ...
                           const InstTree& fixed_instances)
{
  ...
  odb::OdbPtrSet<odb::dbInst> row_insts(
...
{
  const odb::OdbPtrSet<odb::dbMaster> masters = findMasterByType(type);
...
odb::OdbPtrSet<odb::dbMaster> Tapcell::findMasterByType(
