# CUGR mirror of ndr_2w_3s.tcl: 2x-width, 3x-spacing NDR on the clock tree.
# The wider NDR exercises the per-layer demand scaling more aggressively
# than 1w_3s — clock-net edges should carry roughly 2x demand on layers
# the NDR covers.
source "helpers.tcl"
...
set guide_file [make_result_file ndr_2w_3s_cugr.guide]
...
diff_files ndr_2w_3s_cugr.guideok $guide_file
