...
# Save the unrepaired routing for the fresh process to reconstruct from guides.
...
# A separate process guarantees that no in-memory routing survives the reload.
