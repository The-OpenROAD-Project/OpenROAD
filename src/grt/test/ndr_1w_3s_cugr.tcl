# CUGR mirror of ndr_1w_3s.tcl: same NDR + design, routed with `-use_cugr`.
# Exercises CUGR's per-layer NDR cost scaling (Net::ndr_costs_) on a real
# multi-NDR clock tree.
source "helpers.tcl"
...
set guide_file [make_result_file ndr_1w_3s_cugr.guide]
...
diff_files ndr_1w_3s_cugr.guideok $guide_file
