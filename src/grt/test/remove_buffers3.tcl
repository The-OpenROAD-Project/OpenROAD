# buffer removal merging routes that reach the buffer gcell on disjoint
...
set def_file [make_result_file "remove_buffers3.def"]
set segs_file [make_result_file "remove_buffers3.segs"]

write_def $def_file
write_global_route_segments $segs_file

diff_files remove_buffers3.defok $def_file
diff_files remove_buffers3.segsok $segs_file
