...
class GlobalRouter
{
 public:
  ...
  void reportDisconnectedComponents(odb::dbNet* db_net);
  ...
  bool connectCUGRRouting(odb::dbNet* db_net1, odb::dbNet* db_net2, std::vector<GSegment>& connection_out);
  ...
  float getFRNetResistanceOnMinResistanceLayer(odb::dbNet* db_net);
