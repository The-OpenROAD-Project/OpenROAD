...
CUGRPin::CUGRPin(int index, odb::dbITerm* iterm,
...
CUGRPin::CUGRPin(int index, odb::dbBTerm* bterm,
                 const std::vector<BoxOnLayer>& pin_shapes,
                 bool is_port)
...
CUGRNet::CUGRNet(odb::dbNet* db_net, const std::vector<CUGRPin>& pins)
    : db_net_(db_net), pins_(pins)
{
}
