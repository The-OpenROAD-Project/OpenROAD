...
class Net
{
 public:
  ...
  void setIsGuideRestored(bool is_guide_restored)
  {
    is_guide_restored_ = is_guide_restored;
  }
  bool isGuideRestored() const { return is_guide_restored_; }
