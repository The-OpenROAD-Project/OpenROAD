...
| ReduceLoad | `ReduceLoadGenerator` | `ReduceLoadCandidate` |
...
| Removed | `SizeDownMove.cc`, `SizeDownMove.hh` | Replaced by `move/ReduceLoadGenerator.*`, `move/ReduceLoadCandidate.*`. |
