...
create_clock -period 0.1 -name clk
...
repair_design
# second, trigger placement buffering without area tradeoff
...
# third, trigger placement buffering with area tradeoff
# we should see reduced number of buffers
puts "\nSolution under tight timing constraint with tradeoff:"
rsz::fully_rebuffer NULL -ns_area_tradeoff 50
...
puts "\nSolution with reduced tradeoff:"
rsz::fully_rebuffer NULL -ns_area_tradeoff 2.5
report_check_types
summarize_solution
