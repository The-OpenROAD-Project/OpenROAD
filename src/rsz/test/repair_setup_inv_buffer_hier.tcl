# InvBufferMove coverage on a hierarchical netlist. Same long-wire geometry
# as repair_setup_inv_buffer, but the BUF_X4 lives in submod m1 and its iterms
...
# InvBufferCandidate cache flat dbNets and modnets separately.
source "helpers.tcl"
read_liberty Nangate45/Nangate45_typ.lib
read_lef Nangate45/Nangate45.lef
read_verilog repair_setup_inv_buffer_hier.v
link_design reg1 -hier
read_def -floorplan_initialize repair_setup_inv_buffer_hier.def
