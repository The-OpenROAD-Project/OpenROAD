# Legacy VtSwapMove parity test with multi-VT ASAP7 cells.
source "helpers.tcl"
...
repair_timing -setup -sequence "vt_swap" -skip_last_gasp -skip_crit_vt_swap
report_checks -path_delay max -endpoint_path_count 3
