...
endpoints are repaired to reduced the total negative slack. By default
the resizer attempts to repair all violating endpoints. This is can be
time consuming so the -repair_tns_end_percent option can be used to
specify a percent of violating endpoints to repair.
