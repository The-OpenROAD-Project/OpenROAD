...
| `-sequence` | Specify a particular order of setup timing optimizations. The default is "unbuffer,sizeup,swap,buffer,sizedown,clone,split". Obeys skip flags also. |
