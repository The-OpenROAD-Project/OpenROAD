...
// worst delay degradation, and produces a ReduceLoadCandidate if the
// degradation fits the available slack.  Single-threaded only.
class ReduceLoadGenerator : public MoveGenerator
{
 public:
  // === Construction =========================================================
  explicit ReduceLoadGenerator(const GeneratorContext& context);
