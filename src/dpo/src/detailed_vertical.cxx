...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
DetailedVerticalSwap::DetailedVerticalSwap( Architecture* arch, Network* network, RoutingParams* rt ):
    DetailedGenerator(),
    m_mgr( 0 ),
    m_arch( arch ),
    m_network( network ),
...
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
void DetailedVerticalSwap::run( DetailedMgr* mgrPtr, std::vector<std::string>& args )
{
    ...
    for( int p = 1; p <= passes; p++ )
    {
        ...
        std::cout << boost::format( "Pass %3d of vertical swap; hpwl is %.6e\n" ) % p % curr_hpwl;
    ...
    std::cout << boost::format( "End of passes for vertical swap; hpwl is %.6e, total imp is %.2lf%%\n" )
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
bool DetailedVerticalSwap::generate( DetailedMgr* mgr, std::vector<Node*>& candidates )
{
    ++m_attempts;
...
{
    std::cout << "Vertical swap generator, attempts " << m_attempts << ", "
        << "moves " << m_moves << ", "
        << "swaps " << m_swaps
        << std::endl;
}
