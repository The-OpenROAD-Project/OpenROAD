...
_wrap_improve_placement_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"ooo:dpo::improve_placement_cmd seed max_displacement_x max_displacement_y ",(void *)0,(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ...
  {
    try {
      dpo::improve_placement_cmd(arg1,arg2,arg3); 
    }
    catch (std::bad_alloc &) {
