...
read_def nangate_bsg_black_parrot/floorplan_flipchip_short.def
...
add_pdn_connect -layers {metal8 metal10}
add_pdn_connect -layers {metal9 metal10}

pdngen

set def_file [make_result_file pads_black_parrot_flipchip_connect_overpads.def]
write_def $def_file
diff_files pads_black_parrot_flipchip_connect_overpads.defok $def_file
