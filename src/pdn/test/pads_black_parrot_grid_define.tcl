# test for define_pdn_grid -connect_to_pads
source "helpers.tcl"
...
set def_file [make_result_file pads_black_parrot_grid_define.def]
write_def $def_file
diff_files pads_black_parrot_grid_define.defok $def_file
