# test for selecting specific vias for connections
source "helpers.tcl"
...
add_pdn_connect -layers {M1 M2} -cut_pitch 0.288 -fixed_via VIA12
add_pdn_connect -layers {M2 M3}
add_pdn_connect -layers {M3 M6}

pdngen

set def_file [make_result_file asap7_vias_fixed_vias.def]
write_def $def_file
diff_files asap7_vias_fixed_vias.defok $def_file
