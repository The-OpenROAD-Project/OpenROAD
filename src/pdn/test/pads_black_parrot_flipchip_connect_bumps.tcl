...
add_pdn_ring -grid "Bumps" -layers {metal9 metal10} -widths 5.0 -spacings 2.0 -core_offsets 5 -add_connect
add_pdn_stripe -grid "Bumps" -layer metal10 -width 5 -pitch 40.0 -offset 25 -number_of_straps 1  -extend_to_core_ring
