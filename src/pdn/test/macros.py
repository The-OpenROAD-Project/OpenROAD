...
pdn_aux.add_global_connection(design, net_name="VDD",
                              pin_pattern="^VDD$",
                              power=True)
...
pdn_aux.add_global_connection(design, net_name="VSS",
                              pin_pattern="^VSS$",
                              ground=True)
...
pdn_aux.add_pdn_stripe(design, layer="metal4", width=0.48, spacing=4.0, pitch=49.0, offset=2.0)
...
pdn_aux.define_pdn_grid_macro(design, name="sram1",
