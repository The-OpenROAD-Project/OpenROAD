...
define_pdn_grid -macro -name "sram1" -instances "dcache.data.data_arrays_0.data_arrays_0_ext.mem" -halo 5
...
define_pdn_grid -macro -name "sram2" -instances "frontend.icache.data_arrays_0.data_arrays_0_0_ext.mem" -halo 3
