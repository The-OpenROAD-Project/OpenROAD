...
# Voltage domain
set_vottage_domain -name CORE -power VDD -ground VSS
set_voltage_domain -name TEMP_ANALOG -power VIN -ground VSS

add_global_connection -net VIN -inst_pattern {temp_analog_0.*} -pin_pattern VPWR
...
add_pdn_core_ring -layers {met4 met5} -widths 5.0 -spacings 2.0 -core_offsets 4.5}
...
add_pdn_connect -layers {met4_PIN_hor met5}
