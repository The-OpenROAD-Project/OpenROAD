# test for repair channel with large strap spacing
source "helpers.tcl"

read_lef Nangate45/Nangate45.lef
read_lef nangate_macros/fakeram45_64x32.lef

read_def nangate_macros/floorplan_very_narrow.def
...
add_pdn_stripe -layer metal4 -width 0.48 -spacing 15.0 -pitch 65.0 -offset 2.0
...
set def_file [make_result_file macros_narrow_channel_large_spacing.def]
write_def $def_file
diff_files macros_narrow_channel_large_spacing.defok $def_file
