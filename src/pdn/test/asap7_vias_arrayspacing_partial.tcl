# test for incomplete via array at the edge of the straps
source "helpers.tcl"
...
set def_file [make_result_file asap7_vias_arrayspacing_partial.def]
write_def $def_file
diff_files asap7_vias_arrayspacing_partial.defok $def_file
