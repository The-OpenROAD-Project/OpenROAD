# test for stop_at_endcaps, replicating a guardring with metal1 elements on nangate45
...
add_pdn_stripe -followpins -layer metal1 -stop_at_endcaps
...
set def_file [make_result_file stop_at_endcaps.def]
write_def $def_file
diff_files stop_at_endcaps.defok $def_file
