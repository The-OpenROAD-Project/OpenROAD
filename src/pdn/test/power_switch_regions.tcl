...
define_pdn_grid -name "Core" -power_switch_cell POWER_SWITCH -power_control nPWRUP0 -power_control_network STAR
...
define_pdn_grid -name "TempSensor" -voltage_domains "TEMP_ANALOG" -power_switch_cell POWER_SWITCH -power_control nPWRUP1 -power_control_network DAISY
add_pdn_stripe -followpins -layer met1 -width 0.48 -extend_to_core_ring
