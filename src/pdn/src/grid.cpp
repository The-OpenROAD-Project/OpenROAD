...
void Grid::checkSetup() const
{
  ...
  odb::OdbPtrSet<odb::dbTechLayer> follow_pin_layers;
  for (const auto& strap : straps_) {
  ...
  // Check connectivity
  odb::OdbPtrSet<odb::dbTechLayer> check_layers;
  for (const auto& ring : rings_) {
  ...
  const odb::OdbPtrSet<odb::dbNet> nets(nets_vec.begin(), nets_vec.end());
...
odb::OdbPtrSet<odb::dbTechLayer> Grid::connectableLayers(
...
odb::OdbPtrSet<odb::dbInst> Grid::getInstances() const
{
