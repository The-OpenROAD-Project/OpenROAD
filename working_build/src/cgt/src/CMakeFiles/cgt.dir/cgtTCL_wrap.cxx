...
#define SWIG_init    Cgt_Init
#define SWIG_name    "cgt"
#define SWIG_prefix  "cgt::"
#define SWIG_namespace "cgt"
...
#endif
SWIGINTERN int
_wrap_set_min_instances_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:cgt::set_min_instances_cmd min_instances ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_min_instances_cmd" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  {
    try {
      set_min_instances_cmd(arg1); 
    }
    catch (std::bad_alloc &) {
...
SWIGINTERN int
_wrap_set_max_cover_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:cgt::set_max_cover_cmd max_cover ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_max_cover_cmd" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  {
    try {
      set_max_cover_cmd(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_clock_gating_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:cgt::clock_gating_cmd dump_dir ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "clock_gating_cmd" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  {
    try {
      clock_gating_cmd((char const *)arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "set_min_instances_cmd", (swig_wrapper_func) _wrap_set_min_instances_cmd, NULL},
    { SWIG_prefix "set_max_cover_cmd", (swig_wrapper_func) _wrap_set_max_cover_cmd, NULL},
    { SWIG_prefix "clock_gating_cmd", (swig_wrapper_func) _wrap_clock_gating_cmd, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Cgt_SafeInit(Tcl_Interp *interp) {
