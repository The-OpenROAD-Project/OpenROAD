...
QT_INIT_METAOBJECT const QMetaObject gui::TclCmdHighlighter::staticMetaObject = { {
    QMetaObject::SuperData::link<QSyntaxHighlighter::staticMetaObject>(),
    qt_meta_stringdata_gui__TclCmdHighlighter.data,
    qt_meta_data_gui__TclCmdHighlighter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
