...
#define SWIG_init    Fin_Init
#define SWIG_name    "fin"
#define SWIG_prefix  "fin::"
#define SWIG_namespace "fin"
...
#endif
SWIGINTERN int
_wrap_set_density_fill_debug_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":fin::set_density_fill_debug_cmd ") == TCL_ERROR) SWIG_fail;
  {
    try {
      set_density_fill_debug_cmd(); 
    }
...
SWIGINTERN int
_wrap_density_fill_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  odb::Rect *arg2 = 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:fin::density_fill_cmd rules_filename fill_area ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "density_fill_cmd" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  res2 = SWIG_ConvertPtr(objv[2], &argp2, SWIGTYPE_p_odb__Rect,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "density_fill_cmd" "', argument " "2"" of type '" "odb::Rect const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "density_fill_cmd" "', argument " "2"" of type '" "odb::Rect const &""'"); 
  }
  arg2 = reinterpret_cast< odb::Rect * >(argp2);
  {
    try {
      density_fill_cmd((char const *)arg1,(odb::Rect const &)*arg2); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "set_density_fill_debug_cmd", (swig_wrapper_func) _wrap_set_density_fill_debug_cmd, NULL},
    { SWIG_prefix "density_fill_cmd", (swig_wrapper_func) _wrap_density_fill_cmd, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Fin_SafeInit(Tcl_Interp *interp) {
