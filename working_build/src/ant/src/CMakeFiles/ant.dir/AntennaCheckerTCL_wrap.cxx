...
_wrap_check_antennas(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:ant::check_antennas net_name verbose ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "check_antennas" "', argument " "1"" of type '" "char const *""'");
  }
  ...
  {
    try {
      result = (int)ant::check_antennas((char const *)arg1,arg2); 
    }
    catch (std::bad_alloc &) {
...
SWIGINTERN int
_wrap_antenna_violation_count(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int result;
  
  if (SWIG_GetArgs(interp, objc, objv,":ant::antenna_violation_count ") == TCL_ERROR) SWIG_fail;
  {
    try {
      result = (int)ant::antenna_violation_count(); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_report_file_name(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:ant::set_report_file_name file_name ",(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "set_report_file_name" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  {
    try {
      ant::set_report_file_name(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
static swig_command_info swig_commands[] = {
    ...
    { SWIG_prefix "antenna_violation_count", (swig_wrapper_func) _wrap_antenna_violation_count, NULL},
    { SWIG_prefix "check_net_violation", (swig_wrapper_func) _wrap_check_net_violation, NULL},
    { SWIG_prefix "set_report_file_name", (swig_wrapper_func) _wrap_set_report_file_name, NULL},
    {0, 0, 0}
};
