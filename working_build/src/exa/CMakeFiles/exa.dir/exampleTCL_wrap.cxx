...
#define SWIG_init    Exa_Init
#define SWIG_name    "exa"
#define SWIG_prefix  "exa::"
#define SWIG_namespace "exa"
...
_wrap_make_instance_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  ...
  if (SWIG_GetArgs(interp, objc, objv,"o:exa::make_instance_cmd name ",(void *)0) == TCL_ERROR) SWIG_fail;
  ...
  {
    try {
      exa::make_instance_cmd((char const *)arg1); 
    }
    catch (std::bad_alloc &) {
...
_wrap_set_debug_cmd(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":exa::set_debug_cmd ") == TCL_ERROR) SWIG_fail;
  {
    try {
      exa::set_debug_cmd(); 
    }
...
SWIGEXPORT int Exa_SafeInit(Tcl_Interp *interp) {
