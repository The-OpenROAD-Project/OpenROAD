...
#define SWIG_init    Dft_Init
#define SWIG_name    "dft"
#define SWIG_prefix  "dft::"
#define SWIG_namespace "dft"
...
#endif
SWIGINTERN int
_wrap_report_dft_plan(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  bool arg1 ;
  bool val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:dft::report_dft_plan verbose ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_bool SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "report_dft_plan" "', argument " "1"" of type '" "bool""'");
  } 
  arg1 = static_cast< bool >(val1);
  {
    try {
      report_dft_plan(arg1); 
    }
    catch (std::bad_alloc &) {
...
SWIGINTERN int
_wrap_scan_replace(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":dft::scan_replace ") == TCL_ERROR) SWIG_fail;
  {
    try {
      scan_replace(); 
    }
...
SWIGINTERN int
_wrap_execute_dft_plan(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":dft::execute_dft_plan ") == TCL_ERROR) SWIG_fail;
  {
    try {
      execute_dft_plan(); 
    }
...
SWIGINTERN int
_wrap_set_dft_config_max_length(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:dft::set_dft_config_max_length max_length ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_dft_config_max_length" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  {
    try {
      set_dft_config_max_length(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_dft_config_max_chains(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:dft::set_dft_config_max_chains max_chains ",(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_int SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_dft_config_max_chains" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  {
    try {
      set_dft_config_max_chains(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_dft_config_clock_mixing(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  dft::ScanArchitectConfig::ClockMixing arg1 ;
  
  if (SWIG_GetArgs(interp, objc, objv,"o:dft::set_dft_config_clock_mixing clock_mixing ",(void *)0) == TCL_ERROR) SWIG_fail;
  {
    char *str = Tcl_GetStringFromObj(objv[1], 0);
    if (strcasecmp(str, "NO_MIX") == 0) {
      arg1 = dft::ScanArchitectConfig::ClockMixing::NoMix;
    } else /* other values eliminated in typecheck */ {
      arg1 = dft::ScanArchitectConfig::ClockMixing::ClockMix;
    };
  }
  {
    try {
      set_dft_config_clock_mixing(arg1); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_set_dft_config_scan_signal_name_pattern(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:dft::set_dft_config_scan_signal_name_pattern signal_ptr pattern_ptr ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(objv[1], &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "set_dft_config_scan_signal_name_pattern" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  res2 = SWIG_AsCharPtrAndSize(objv[2], &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "set_dft_config_scan_signal_name_pattern" "', argument " "2"" of type '" "char const *""'");
  }
  arg2 = reinterpret_cast< char * >(buf2);
  {
    try {
      set_dft_config_scan_signal_name_pattern((char const *)arg1,(char const *)arg2); 
    }
    catch (std::bad_alloc &) {
      fprintf(stderr, "Error: out of memory.");
      abort();
...
SWIGINTERN int
_wrap_report_dft_config(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":dft::report_dft_config ") == TCL_ERROR) SWIG_fail;
  {
    try {
      report_dft_config(); 
    }
...
SWIGINTERN int
_wrap_scan_opt(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  if (SWIG_GetArgs(interp, objc, objv,":dft::scan_opt ") == TCL_ERROR) SWIG_fail;
  {
    try {
      scan_opt(); 
    }
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "report_dft_plan", (swig_wrapper_func) _wrap_report_dft_plan, NULL},
    { SWIG_prefix "scan_replace", (swig_wrapper_func) _wrap_scan_replace, NULL},
    { SWIG_prefix "execute_dft_plan", (swig_wrapper_func) _wrap_execute_dft_plan, NULL},
    { SWIG_prefix "set_dft_config_max_length", (swig_wrapper_func) _wrap_set_dft_config_max_length, NULL},
    { SWIG_prefix "set_dft_config_max_chains", (swig_wrapper_func) _wrap_set_dft_config_max_chains, NULL},
    { SWIG_prefix "set_dft_config_clock_mixing", (swig_wrapper_func) _wrap_set_dft_config_clock_mixing, NULL},
    { SWIG_prefix "set_dft_config_scan_signal_name_pattern", (swig_wrapper_func) _wrap_set_dft_config_scan_signal_name_pattern, NULL},
    { SWIG_prefix "report_dft_config", (swig_wrapper_func) _wrap_report_dft_config, NULL},
    { SWIG_prefix "scan_opt", (swig_wrapper_func) _wrap_scan_opt, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Dft_SafeInit(Tcl_Interp *interp) {
