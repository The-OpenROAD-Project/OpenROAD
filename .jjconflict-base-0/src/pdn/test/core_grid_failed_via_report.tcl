# test for failed via report
source "helpers.tcl"

read_lef Nangate45/Nangate45.lef
read_def nangate_gcd/floorplan_obstructions.def
...
set rpt_file [make_result_file core_grid_failed_via_report.rpt]
pdngen -failed_via_report $rpt_file

diff_files core_grid_failed_via_report.rptok $rpt_file
