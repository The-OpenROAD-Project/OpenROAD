...
add_pdn_stripe -layer metal4 -width 1.0 -pitch 5.0 -offset 2.5 \
  -number_of_straps 2 -extend_to_core_ring
...
set def_file [make_result_file core_grid_strap_count.def]
write_def $def_file
diff_files core_grid_strap_count.defok $def_file
