...
static void merge(char *dst, const char *src1, size_t n1,
                  const char *src2, size_t n2, size_t size,
                  int (*compar)(const void *, const void *))
{
    while (n1 > 0 && n2 > 0) {
    ...
    if (n1 > 0) memcpy(dst, src1, n1 * size);
    if (n2 > 0) memcpy(dst, src2, n2 * size);
}
...
static void merge_r(char *dst, const char *src1, size_t n1,
                    const char *src2, size_t n2, size_t size,
                    void *thunk,
                    int (*compar)(void *, const void *, const void *))
{
...
static void msort_with_tmp_r(void *base, size_t nmemb, size_t size,
                              void *thunk,
                              int (*compar)(void *, const void *, const void *),
                              char *tmp)
{
