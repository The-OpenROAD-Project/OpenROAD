...
```
set_global_routing_region_adjustment -lower_x <lower_x> -lower_y <lower_y>
...
The region is defined as a rectangle in a routing layer. The rectangle should be defined in DBU
Example: `set_global_routing_region_adjustment -lower_x 0 -lower_y 0
                                               -upper_x 50000 -upper_y 50000
                                               -layer 4 -adjustment 0.4`
