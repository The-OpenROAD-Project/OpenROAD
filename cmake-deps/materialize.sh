...
echo ""
echo "Build OpenROAD with plain CMake (cmake and ninja are bundled):"
echo ""
echo "  $ABS_DEST/bin/cmake -DCMAKE_TOOLCHAIN_FILE=$ABS_DEST/toolchain.cmake -G Ninja -B build ."
echo "  $ABS_DEST/bin/cmake --build build -j\$(nproc)"
echo ""
...
echo "  ./build/bin/openroad"
echo ""
echo "Host requirements: git, bash. Linux x86_64 only; the GUI is not"
echo "part of this prefix."
