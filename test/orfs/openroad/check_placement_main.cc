...
//
// Standalone check_placement binary.
// Links only dpl + odb + utl.
//
// Usage:
//   check_placement --read_db in.odb [-verbose] [-report_file_name file]
//   check_placement --read_lef tech.lef --read_def placed.def [-verbose]
...
void usage(const char* prog)
{
  std::cerr << "Usage: " << prog << " [options]\n"
            ...
            << "  -report_file_name FILE  Write report to file\n";
}
...
int main(int argc, char* argv[])
{
  ...
  opendp.checkPlacement(opts.verbose, opts.report_file);
