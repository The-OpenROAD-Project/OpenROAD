...
set env(DESIGN_DIR) "./"
set env(DESIGN_HOME) "$::env(FLOW_HOME)/designs"
...
set env(PLATFORM_HOME) "$::env(FLOW_HOME)/platforms"
set env(PROCESS) "7"
...
set env(SYNTH_SCRIPT) "$::env(FLOW_HOME)/scripts/synth.tcl"
...
set env(TEST_DIR) "$::env(FLOW_HOME)/test"
...
set env(USE_FILL) "0"
set env(UTILS_DIR) "$::env(FLOW_HOME)/util"
